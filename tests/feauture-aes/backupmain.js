...
function encrypt(algorithm, password, salt, data) {
    ...
    // 鍵を生成
    const key = CryptoJS.scryptSync(password, salt, 32)
...
const data = window.btoa(MESSAGE);
console.log('data:', data)
console.log('CRYPTO')

const word = 'Awesome python!!'
const pwd =  'this is secret:)'

const decr = CryptoJS.AES.decrypt(word, pwd)
